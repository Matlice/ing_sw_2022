        ...
        }
        {
            ...
            \auxcase{
                \begin{tabular}{l}
                    ...
                    3.a Mostrando un messaggio di errore, si ritorna al \\menu principale.\\
                    Fine.
                \end{tabular}
            }\\
            ...
            \auxcase{
                \begin{tabular}{l}
                    ...
                    3.a Mostrando un messaggio di errore ritorna al punto 1.\\
                    Fine.
                \end{tabular}
            }\\
            ...
            \auxcase{
                \begin{tabular}{l}
                    ...
                    3.a Mostrando un messaggio di errore, si ritorna al punto 1.\\
                    Fine.
                \end{tabular}
            }\\
