...
\end{frame}
\note{
    Sarebbe richiesta anche l'implementazione effettiva della View SwingView e dei suoi adattatori per le classi di modello, i quali potrebbero tornare un JFrame invece che una String
}